public class B3_HalfTheRed extends World {
    ...
    public void go() {
        ...
        System.out.println(plane.howMuchRed());// howMuchRed is a method that tells us "r" value of the plane's current pixel

        for (int row = 158; row < 220; row = row + 1) {
            for (int col = 130; col < 204; col++) {// x=x+1 also is x+=1 or x++
